...
//which will be an array of numbers. Inside of the bigOrSmall function, create a new array called 'answers'. 
//Then, loop over the passed in arr parameter, and check to see if the number in the array is GREATER than 100. 
//If it is, push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100, push 'small' 
//as a string to the answers array. Return the answers array inside of the function.
...
// Below is an array, myNumbers. You will be using .map, .filter, .reduce and .forEach 
//to manipulate the array in the following problems.
...
// Code Here
var doubled = myNumbers.map(myFunction)
...
// Code Here
 var total = myNumbers.reduce(getSum)
